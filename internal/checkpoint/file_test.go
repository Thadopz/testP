...
func TestFileStoreSaveThenLoadCheckpoint(t *testing.T) {
...
func TestFileStoreLoadUnknownCheckpointReturnsNotFound(t *testing.T) {
...
func TestFileStoreCopiesCheckpointOnSave(t *testing.T) {
...
func TestFileStoreSaveReturnsContextError(t *testing.T) {
	store := NewFileStore(t.TempDir())
...
func TestFileStoreLoadReturnsContextError(t *testing.T) {
	store := NewFileStore(t.TempDir())
	ctx, cancel := context.WithCancel(context.Background())
	cancel()
