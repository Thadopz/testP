...
func TestSweepControllerKeepsOwnershipAfterLeaderSwitch(t *testing.T) {
	...
	sweepController(context.Background(), ownershipStore, membershipStore, failoverController, firstElection, 6)
	...
	sweepController(context.Background(), ownershipStore, membershipStore, failoverController, secondElection, 6)
...
func TestSweepControllerRecoversAfterEtcdTemporarilyUnavailable(t *testing.T) {
	...
	sweepController(context.Background(), ownershipStore, membershipStore, failoverController, leaderElection, 4)
	before := mustListOwnerships(t, ownershipStore)
	if len(before) != 4 {
	...
	sweepController(context.Background(), recoveredOwnershipStore, recoveredMembershipStore, recoveredFailoverController, recoveredElection, 4)
...
func TestSweepControllerRecordsMetrics(t *testing.T) {
	client := startControllerEtcd(t)
